...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '前端用户表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_users` VALUES (38, 'root', '123', 1, 1520335586, 'aabbb', 1520594800, 1521187638, '/src/img/832', 1, 1);
...
INSERT INTO `vm_users` VALUES (45, 'ha', 'asdsad', 2, 1520234497, '9999999999999999999999999', 1521530501, 1521977840, '/src/img/897', 1, 1);
...
CREATE TABLE `vm_users_login_logs`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '前端用户登录记录' ROW_FORMAT = Compact;
