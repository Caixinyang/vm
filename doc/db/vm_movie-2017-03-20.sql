...
CREATE TABLE `vm_filmmakers`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '电影人基本信息表(包括演员，导演等)' ROW_FORMAT = Compact;
...
INSERT INTO `vm_filmmakers` VALUES (9, 'zhangke', '123', '123', 2, 2, 1521781494, '123', '123', '/src/img/858', 1521435899, 1521435899, 1, 2);
INSERT INTO `vm_filmmakers` VALUES (10, '张可', '12313', '1231', 6, 2, 1522215221, '3333', '1111', '/src/img/857', 1521437627, 1521438720, 1, 1);
INSERT INTO `vm_filmmakers` VALUES (11, '张大可', '张大可二号', '阿萨', 3, 2, 1520315656, '阿萨', '阿萨达', '/src/img/856', 1521438866, 1521454623, 1, 2);
INSERT INTO `vm_filmmakers` VALUES (12, '安七炫', 'kangta', '我只是个演员', 3, 1, 1521165308, '大韩民国', '大韩民国大韩民国大韩民国', '/src/img/862', 1521510934, 1521510934, 1, 2);
...
CREATE TABLE `vm_movies`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '电影表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of vm_movies
-- ----------------------------
INSERT INTO `vm_movies` VALUES (23, '123', '123', '123', NULL, 1520243773, 10.0, 0, 123, '/src/img/849', '/src/img/847', 1521194204, 1521194489, 1, 2);
INSERT INTO `vm_movies` VALUES (24, '12313', '123', '123', NULL, 1520935198, 10.0, 0, 123, '/src/img/854', '/src/img/852', 1521194400, 1521421818, 1, 1);
