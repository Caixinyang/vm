...
INSERT INTO `vm_filmmakers` VALUES (8, '布拉德·皮特', 'Brad Pitt', '演员', 1, 1, 1519620328, '美国', '1987年，皮特以临时演员的身份参加了他的第一部电影《无主地》的拍摄。1993年，皮特出演《加州杀手》，并凭此片获得威尼斯电影节最佳男演员奖[1]  。1995年，皮特出演《十二只猴子》，并凭借片中的表演获得了奥斯卡最佳男配角奖的提名。', '/src/img/859', 1521434736, 1522862852, 1, 2);
INSERT INTO `vm_filmmakers` VALUES (9, 'zhangke', '123', '123', 2, 2, 1521781494, '123', '123', '/src/img/858', 1521435899, 1522862843, 1, 1);
...
-- ----------------------------
INSERT INTO `vm_movies` VALUES (23, '123', '123', '123', 13, 1520243773, 10.0, 0, 123, '/src/img/997', '/src/img/996', 1521194204, 1521788911, 1, 1);
INSERT INTO `vm_movies` VALUES (24, '12313', '123', '123', 8, 1520935198, 10.0, 0, 123, '/src/img/991', '/src/img/989', 1521194400, 1521795019, 1, 1);
INSERT INTO `vm_movies` VALUES (25, 'asdas', '12313', 'asdada阿斯达多', 13, 1520233248, 10.0, 0, 123, '/src/img/995', '/src/img/994', 1521529255, 1523092791, 1, 1);
...
CREATE TABLE `vm_movies_filmmakers_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 196 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影及其电影人表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (191, 25, 11, 1523092792, 1523092792, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (192, 25, 13, 1523092792, 1523092792, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (193, 25, 9, 1523092792, 1523092792, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (194, 25, 8, 1523092792, 1523092792, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (195, 25, 12, 1523092792, 1523092792, 1, 1);
...
CREATE TABLE `vm_movies_tags_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 121 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影标签表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_tags_realation` VALUES (120, 25, 35, 1523092792, 1523092792, 1, 1);
