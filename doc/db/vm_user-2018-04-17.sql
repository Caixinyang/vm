...
-- Records of vm_users
-- ----------------------------
INSERT INTO `vm_users` VALUES (1, '张大可aaa', '123456789', 2, 1521538534, '14141阿达撒旦aaaaaaaaaaaa', 1500443357, 1520563814, '/src/img?fileId=620', 1, 1);
...
INSERT INTO `vm_users` VALUES (38, 'root', '123', 1, 1520335586, '啦啦啦', 1520594800, 1523267899, '/src/img/1022', 1, 1);
...
INSERT INTO `vm_users` VALUES (46, '1', '1', 1, 422175960, '2', 1522821964, 1523416482, '/src/img/910', 1, 2);
...
CREATE TABLE `vm_users_login_logs`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '前端用户登录记录' ROW_FORMAT = Compact;
