...
-- ----------------------------
INSERT INTO `vm_filmmakers` VALUES (1, 'zhangke', '', '演员/daoyan ', 0, 0, 3, 13546, '成都', '厉害了', '/src/img?fileId=-1', 1, 123, 1233);
INSERT INTO `vm_filmmakers` VALUES (2, '张大可张大可张大可张大可张大可张大可张大可张大可张大可张大可', '', '演员/daoyan ', 0, 0, 3, 213, '眉山', '大眉山', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_filmmakers` VALUES (3, '布拉-德皮特', '', '演员', 0, 0, 3, 12321, 'ASDSA', 'ASDSA', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_filmmakers` VALUES (4, '周杰伦', 'jack/杰伦周', '中国台湾流行乐男歌手、音乐人、演员、导演、编剧、监制、商人', 0, 0, 3, 12312553, '中国大陆', '周杰伦出生于台湾省新北市，祖籍福建省永春县[24]  。周杰伦4岁的\r\n周杰伦小时候\r\n周杰伦小时候(17张)\r\n 时候，母亲叶惠美把他送到淡江山叶幼儿音乐班学习钢琴[25]  。周杰伦读初中二年级时，他的父母因性格不合离婚，而周杰伦则归母亲叶惠美抚养[26]  。中考时，周杰伦没有考上普通高中；同年，他因为擅长钢琴而被淡江中学第一届音乐班录取。高中毕业以后，他两次报考台北大学音乐系均没有被录取，于是他开始在一家餐馆打工[25]  。', '/src/img?fileId=-1', 1, 12312, 123);
...
-- ----------------------------
INSERT INTO `vm_movies` VALUES (1, '北京爱上西雅图', '电影aaa', '已在香港立足开馆的叶问（甄子丹 饰）与太太张永成（熊黛林 饰）平静地生活，不料小儿子叶正就读的小学发生了流氓滋扰事件，参与闹事的正是田傲山（梁家仁 饰）昔日的徒弟马鲸笙（谭耀文 饰）。于是叶问带领徒弟徐力（张继聪 饰）等人保护了黄老师（吴千语 饰）、校长（刘以达 饰）以及众小学生，并结识了同样是咏春传人的车夫张天志（张晋 饰），二人惺惺相惜。可是事件却没有止步于此，马鲸笙的老板费兰奇（迈克·泰森 饰）才是幕后黑手，探长肥波（郑则仕 饰）也卷入了其中，与此同时，张天志向叶问发起了谁是“正宗咏春”的挑战，叶问该如何应战？', 2, 1, 9.9, 100, 12312, 'http://mpic.tiankong.com/8e1/58f/8e158fc2b4bb795e202a4f0196bf9cb9/640.jpg', '/src/img?fileId=-1', 1, 1231, 123);
INSERT INTO `vm_movies` VALUES (2, '甲方乙方', 'bbb', '哈哈', 2, 123, 2.0, 1000, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (3, '长龙卧虎', 'asdad', 'asdad', 3, 123, 3.0, 78, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (4, '惊变28周', 'asdad', 'asdad', 2, 123, 3.0, 787, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (5, '天下第一', 'asdad', 'asdad', 2, 123, 3.0, 45, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (6, '庇护', 'asdad', 'asdad', 3, 123, 3.0, 789797, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (7, '山村老尸', 'asdad', 'asdad', 3, 123, 3.0, 877, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (8, '一个勺子', 'asdad', 'asdad', 3, 123, 3.0, 4566, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (9, '甲方乙方', 'asdad', 'asdad', 3, 123, 3.0, 10, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (10, '我的世界', 'asdad', 'asdad', 2, 123, 3.0, 10456, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (11, '惊变28天', 'asdad', 'asdad', 9, 123, 3.0, 4567, 123, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (12, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (13, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (14, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (15, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (16, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (17, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (18, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (19, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (20, '地球停转之日', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
INSERT INTO `vm_movies` VALUES (21, '齐天大圣', '地球停转之日/地球停转之日', '地球停转之日地球停转之日', 112, 123, 9.6, 555, 99, '/movie/src/33', '/src/img?fileId=-1', 1, 123, 123);
...
-- ----------------------------
INSERT INTO `vm_movies_src_version` VALUES (1, 1, 1, 1, 1, 1, 1, '/src/video/1');
INSERT INTO `vm_movies_src_version` VALUES (2, 1, 2, 2, 2, 1, 10, '/src/video/1');
