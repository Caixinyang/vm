...
CREATE TABLE `vm_files` (
  ...
  `create_time` int(10) unsigned NOT NULL COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL COMMENT '更新时间',
  `content_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件类型，如video/mp4',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=203 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='文件信息表';
...
-- ----------------------------
INSERT INTO `vm_movies_src_version` VALUES ('1', '1', '1', '1', '1', '1', '1', '/movie/src/35');
...
CREATE TABLE `vm_users` (
  ...
  `username` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '唯一用户名',
  `password` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '用户密码，md5加密',
  `sex` tinyint(2) unsigned NOT NULL DEFAULT '3' COMMENT '性别，1为男，1为女，3未设置',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='前端用户表';

-- ----------------------------
-- Records of vm_users
-- ----------------------------
INSERT INTO `vm_users` VALUES ('27', 'root', '123', '3', null, null, '1', '1514453354', '1514453354', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('28', 'root1', '123', '3', null, null, '1', '1514453431', '1514453431', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('29', 'root12', '123', '3', null, null, '1', '1514453475', '1514453475', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('30', '123', '123', '3', null, null, '1', '1514455948', '1514455948', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('31', 'root11111', '123', '3', null, null, '1', '1514513097', '1514513097', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('32', 'qwe', '123', '3', null, null, '1', '1514526446', '1514526446', '/user/img/-1');
INSERT INTO `vm_users` VALUES ('33', '123321', '123321', '3', null, null, '1', '1514529783', '1514529783', '/user/img/-1');
