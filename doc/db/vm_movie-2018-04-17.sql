...
INSERT INTO `vm_filmmakers` VALUES (8, '布拉德·皮特', 'Brad Pitt', '演员', 1, 1, 1519620328, '美国', '1987年，皮特以临时演员的身份参加了他的第一部电影《无主地》的拍摄。1993年，皮特出演《加州杀手》，并凭此片获得威尼斯电影节最佳男演员奖[1]  。1995年，皮特出演《十二只猴子》，并凭借片中的表演获得了奥斯卡最佳男配角奖的提名。', '/src/img/859', 1521434736, 1523249931, 1, 1);
INSERT INTO `vm_filmmakers` VALUES (9, '周星驰', '123', '123', 2, 1, 1521781494, '123', '123', '/src/img/858', 1521435899, 1523249799, 1, 1);
...
INSERT INTO `vm_filmmakers` VALUES (12, '安七炫', 'kangta', '我只是个演员', 3, 1, 1521165308, '大韩民国', '大韩民国大韩民国大韩民国', '/src/img/909', 1521510934, 1522952077, 1, 1);
INSERT INTO `vm_filmmakers` VALUES (13, '刘二狗', '刘二狗二世', '演员', 3, 1, 1520924571, '美国', '星驰 编辑 \n1962年6月22日 香港 中国\n周星驰，1962年6月22日生于香港，祖籍浙江宁波，中国香港演员、导演、编剧、制作人、商人，毕业于无线电视艺员训练班。\n1980年成为丽的电视台的特约演员，从而进入演艺圈。1981年出演个人首部电视剧《IQ成熟时》。1988年将演艺', '/src/img/924', 1521529385, 1523846359, 1, 1);
...
-- ----------------------------
INSERT INTO `vm_movies` VALUES (23, '123', '123', '123', 13, 1520243773, 10.0, 0, 123, '/src/img/1008', '/src/img/1007', 1521194204, 1521788911, 1, 1);
INSERT INTO `vm_movies` VALUES (24, 'V字仇杀队', 'V', 'V字仇杀队', 8, 1520935198, 10.0, 0, 123, '/src/img/1004', '/src/img/1003', 1521194400, 1523249861, 1, 1);
INSERT INTO `vm_movies` VALUES (25, '哈利波特-1', '哈利波特-1', '哈利波特-1', 9, 1520233248, 10.0, 0, 123, '/src/img/1002', '/src/img/1001', 1521529255, 1523249893, 1, 1);
...
CREATE TABLE `vm_movies_filmmakers_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 207 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影及其电影人表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (176, 25, 11, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (177, 25, 13, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (178, 25, 9, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (179, 25, 8, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (180, 25, 12, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (181, 24, 9, 1521795019, 1521795019, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (182, 24, 11, 1521795019, 1521795019, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (183, 24, 8, 1521795019, 1521795019, 2, 1);
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (191, 25, 11, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (192, 25, 13, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (193, 25, 9, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (194, 25, 8, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (195, 25, 12, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (196, 25, 11, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (197, 25, 13, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (198, 25, 9, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (199, 25, 8, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (200, 25, 12, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (201, 24, 8, 1523249861, 1523249861, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (202, 25, 11, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (203, 25, 13, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (204, 25, 9, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (205, 25, 8, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (206, 25, 12, 1523249893, 1523249893, 1, 1);
...
INSERT INTO `vm_movies_src_version` VALUES (12, 1521904246, 1523238019, 2, 24, 1, '/src/video/895', 1, 1);
...
INSERT INTO `vm_movies_src_version` VALUES (16, 1523626146, 1523626146, 2, 25, 1, '/src/video/1026', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (17, 1523626188, 1523626188, 3, 25, 1, '/src/video/1027', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (18, 1523627777, 1523627777, 2, 25, 1, '/src/video/1030', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (19, 1523627802, 1523627802, 2, 23, 1, '/src/video/1031', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (20, 1523634637, 1523634637, 3, 25, 1, '/src/video/1032', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (21, 1523634824, 1523634824, 2, 25, 1, '/src/video/1033', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (22, 1523640092, 1523640092, 2, 25, 1, '/src/video/1034', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (23, 1523640112, 1523640112, 2, 24, 1, '/src/video/1035', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (24, 1523708979, 1523708979, 3, 25, 1, '/src/video/1038', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (25, 1523709039, 1523709039, 3, 24, 1, '/src/video/1039', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (26, 1523845200, 1523845200, 2, 25, 1, '/src/video/1040', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (27, 1523845243, 1523845243, 1, 23, 1, '/src/video/1041', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (28, 1523855024, 1523855024, 3, 25, 1, '/src/video/1042', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (29, 1523858060, 1523858060, 2, 25, 1, '/src/video/1043', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (30, 1523858945, 1523858945, 3, 25, 1, '/src/video/1044', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (31, 1523870886, 1523870886, 2, 25, 1, '/src/video/1045', 1, 1);
...
CREATE TABLE `vm_movies_tags_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 131 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影标签表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_tags_realation` VALUES (111, 25, 35, 1521795007, 1521795007, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (112, 24, 35, 1521795020, 1521795020, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (113, 24, 39, 1521795020, 1521795020, 2, 1);
...
INSERT INTO `vm_movies_tags_realation` VALUES (120, 25, 35, 1523092792, 1523092792, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (121, 25, 35, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (122, 25, 39, 1523249596, 1523249596, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (123, 24, 35, 1523249861, 1523249861, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (124, 24, 40, 1523249861, 1523249861, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (125, 24, 46, 1523249861, 1523249861, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (126, 25, 35, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (127, 25, 39, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (128, 25, 45, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (129, 25, 47, 1523249893, 1523249893, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (130, 25, 46, 1523249893, 1523249893, 1, 1);
...
CREATE TABLE `vm_tags`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '电影标签' ROW_FORMAT = Compact;
...
INSERT INTO `vm_tags` VALUES (35, '90年代', 16, 1521792852, 1523249709, 1, 1);
...
INSERT INTO `vm_tags` VALUES (40, '美国', 17, 1523249612, 1523249612, 1, 1);
INSERT INTO `vm_tags` VALUES (41, '德国', 17, 1523249617, 1523249617, 1, 1);
INSERT INTO `vm_tags` VALUES (42, '新加坡', 17, 1523249624, 1523249624, 1, 1);
INSERT INTO `vm_tags` VALUES (43, '日韩', 17, 1523249632, 1523249632, 1, 1);
INSERT INTO `vm_tags` VALUES (44, '欧美', 17, 1523249641, 1523249641, 1, 1);
INSERT INTO `vm_tags` VALUES (45, '惊悚', 18, 1523249663, 1523249663, 1, 1);
INSERT INTO `vm_tags` VALUES (46, '悬疑', 18, 1523249672, 1523249672, 1, 1);
INSERT INTO `vm_tags` VALUES (47, '恐怖', 18, 1523249681, 1523249681, 1, 1);
INSERT INTO `vm_tags` VALUES (48, '喜剧', 18, 1523249688, 1523249688, 1, 1);
INSERT INTO `vm_tags` VALUES (49, '伦理', 18, 1523249695, 1523249695, 1, 1);
INSERT INTO `vm_tags` VALUES (50, '00年', 16, 1523249723, 1523249723, 1, 1);
INSERT INTO `vm_tags` VALUES (51, '2010年代', 16, 1523249741, 1523249741, 1, 1);
...
CREATE TABLE `vm_tags_groups`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '标签组' ROW_FORMAT = Compact;
...
INSERT INTO `vm_tags_groups` VALUES (18, '类型', 1523249651, 1523249651, 1, 1);
