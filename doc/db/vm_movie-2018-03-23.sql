...
INSERT INTO `vm_filmmakers` VALUES (8, '布拉德·皮特', 'Brad Pitt', '演员', 1, 1, 1519620328, '美国', '1987年，皮特以临时演员的身份参加了他的第一部电影《无主地》的拍摄。1993年，皮特出演《加州杀手》，并凭此片获得威尼斯电影节最佳男演员奖[1]  。1995年，皮特出演《十二只猴子》，并凭借片中的表演获得了奥斯卡最佳男配角奖的提名。', '/src/img/859', 1521434736, 1521437608, 1, 1);
...
INSERT INTO `vm_movies` VALUES (26, '绝代无双', '绝代无双2', '绝代无双绝代无双', 8, 1520925071, 10.0, 0, 12, '/src/img/870', '/src/img/871', 1521529881, 1521793853, 1, 1);
INSERT INTO `vm_movies` VALUES (27, '测试1', '12313', '《鬼吹灯之寻龙诀》根据天下霸唱所著盗墓小说《鬼吹灯》的后四部改编而成。是由乌尔善执导的悬疑动作片，陈坤、黄渤、舒淇、杨颖、夏雨领衔主演的一部动作、悬疑电影。该片主要讲述胡八一、王凯旋与Shirley杨再入草原千年古墓发生的故事。该片于2014年8月开机，2015年12月18日上映，以3D、IMAX 3D、ScreenX等多种版本同步上映。 >>>', 11, 1520321636, 10.0, 0, 12, '/src/img/875', '/src/img/876', 1521790466, 1521794997, 1, 1);
...
CREATE TABLE `vm_movies_filmmakers_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 184 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影及其电影人表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (163, 26, 11, 1521793854, 1521793854, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (164, 26, 13, 1521793854, 1521793854, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (165, 26, 9, 1521793854, 1521793854, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (166, 26, 8, 1521793854, 1521793854, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (167, 26, 12, 1521793854, 1521793854, 1, 1);
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (175, 27, 12, 1521794997, 1521794997, 1, 1);
...
CREATE TABLE `vm_movies_tags_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 114 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影标签表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_tags_realation` VALUES (109, 27, 35, 1521794998, 1521794998, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (110, 27, 39, 1521794998, 1521794998, 1, 1);
